  ...
  return (
    <div>
      <nav className="bg-blackishbg p-4 shadow-md">
        <h1 className="text-2xl font-bold text-center text-white">GUARDMIND- AN AI-POWERED MENTAL HEALTH SUPPORT PLATFORM</h1>
      </nav>
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blackishbg to-blackishbginside" style={{backgroundImage:'url(https://thumbs.dreamstime.com/b/mental-fitness-word-cloud-white-background-mental-fitness-word-cloud-108487964.jpg)'}}>
        <div className="bg-white p-8 rounded-lg shadow-md w-96">
          <h2 className="text-2xl font-bold mb-6 text-center text-dark-maroon">
